...
const HeroCards = () => {
  return (
    <section className='w-full grid grid-cols-2 lg:grid-cols-4 max-container'>
        {pages.map(item =>  
            <a href={item.link} className='my-12'>
                <div className='rounded p-4 bg-teal-600/90 w-fit flex flex-col justify-center m-auto h-full hover:scale-125 transition-all'>
